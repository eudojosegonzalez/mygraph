...
class DetalleCotizacionRepository extends ServiceEntityRepository
{
    ...
    public function searchDetallesCotizacion (int $idCotizacion) : array {
        ...
        cotizacion.por_descuento as pordesgen,
        cotizacion.monto_descuento as mondesgen,
        ...
        detalle_cotizacion.porcentaje_descuento as pordesreng,
        detalle_cotizacion.monto_descuento as mondesreng,
        inventario.codigo,
        inventario.nombre,
        inventario.modelo,
        inventario.estado,
